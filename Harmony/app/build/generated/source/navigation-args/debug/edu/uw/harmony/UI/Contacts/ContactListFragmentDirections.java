...
public class ContactListFragmentDirections {
  ...
  @NonNull
  public static ActionContactListFragment2ToContactCardFragment actionContactListFragment2ToContactCardFragment(
      @NonNull ContactCard contact) {
    return new ActionContactListFragment2ToContactCardFragment(contact);
  }

  public static class ActionContactListFragment2ToContactCardFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionContactListFragment2ToContactCardFragment(@NonNull ContactCard contact) {
      if (contact == null) {
    ...
    @NonNull
    public ActionContactListFragment2ToContactCardFragment setContact(
        @NonNull ContactCard contact) {
      if (contact == null) {
        throw new IllegalArgumentException("Argument \"contact\" is marked as non-null but was passed a null value.");
      }
    ...
    public int getActionId() {
      return R.id.action_contactListFragment2_to_contactCardFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionContactListFragment2ToContactCardFragment that = (ActionContactListFragment2ToContactCardFragment) object;
    ...
    public String toString() {
      return "ActionContactListFragment2ToContactCardFragment(actionId=" + getActionId() + "){"
          + "contact=" + getContact()
          + "}";
    }
  }
