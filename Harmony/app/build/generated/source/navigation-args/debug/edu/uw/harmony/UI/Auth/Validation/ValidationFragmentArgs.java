...
public class ValidationFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ValidationFragmentArgs() {
  }

  private ValidationFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ValidationFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ValidationFragmentArgs __result = new ValidationFragmentArgs();
    bundle.setClassLoader(ValidationFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ValidationFragmentArgs that = (ValidationFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(ValidationFragmentArgs original) {
    ...
    @NonNull
    public ValidationFragmentArgs build() {
      ValidationFragmentArgs result = new ValidationFragmentArgs(arguments);
      return result;
    }
