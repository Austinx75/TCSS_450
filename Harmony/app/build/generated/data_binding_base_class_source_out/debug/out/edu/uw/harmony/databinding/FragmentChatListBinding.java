...
public final class FragmentChatListBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton buttonNewChat;
  ...
  private FragmentChatListBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton buttonNewChat, @NonNull ConstraintLayout layoutRoot,
  ...
  public static FragmentChatListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FloatingActionButton buttonNewChat = rootView.findViewById(id);
